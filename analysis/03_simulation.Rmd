...
# 12 scenarios x 50 reps = 600 rows
...
knitr::kable(t1_tab, caption="Type I error at calibrated thresholds (exact 95% CI), 200 null reps per trait")

knitr::kable(data.frame(method=c("ras-ss","indiv","pure ras()"), s_per_rep=round(c(t_ss,t_in,t_pu),1)),
             caption="Runtime seconds per rep, single core")
...
# FPR, average number of false regions called per rep
